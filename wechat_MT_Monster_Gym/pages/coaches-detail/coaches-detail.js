...
Page({
  ...
  onLoad: function (options) {
    ...
    const that = this;
    wx.request({
      url: 'http://127.0.0.1:8000/appointment_detail',
      data: {
        id: coachId
      },
  ...
  appointtap:function(){
    if (this.data.selendTime === "请选择" || this.data.selstartTime === "请选择"){
      wx.showToast({
        title: '预约时段有误',
        image: '../../resource/image/activity/appointment/popup-close.png'
      });
      return;
    }
  ...
  modalHide: function () {
    ...
    wx.showModal({
      title: '提示',
      content: '预约成功，具体预约情况请与健身房沟通，谢谢配合。',
    })
  },
